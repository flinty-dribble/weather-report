import { getWeatherById, getWeather } from "./weatherId";
...
describe("weather report", () => {
  ...
  it("input and button", async () => {
    ...
    const inputLat: HTMLInputElement | null = el.querySelector(".inputLat");
    const inputLon: HTMLInputElement | null = el.querySelector(".inputLon");
    ...
    if (
      ...
      const res = await getWeatherById(
        city,
        temp,
        icon,
        description,
